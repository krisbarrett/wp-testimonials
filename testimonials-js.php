...
$j(document).ready(function(){
	...
	$j("input#submit").click(function() {
		...
		if(name.val() == "") {
			$j("label#name_label").attr("style", "color:red");
		}
		else {
			$j("label#name_label").attr("style", "color:black");
		}
		if(email.val() == "") {
			$j("label#email_label").attr("style", "color:red");
		}
		else {
			$j("label#email_label").attr("style", "color:black");
		}
		if(testimonial.val() == "") {
			$j("label#testimonial_label").attr("style", "color:red");
		}
		else {
			$j("label#testimonial_label").attr("style", "color:black");
		}
